                ...
                $.post(ajaxurl, {
                    ...
                    function (response) {
                        if (_.isObject(response) && 'success' in response && 'data' in response) {
                            ...
                            if (_.size(data) >= 1 || $.inArray(connect_service, ['RegisteredUsersConnect', 'MemberPressConnect', 'WooCommerceConnect', 'WooMembershipConnect']) !== -1) {
                                ...
                                if ($.inArray(connect_service, ['RegisteredUsersConnect', 'MemberPressConnect', 'WooCommerceConnect', 'WooMembershipConnect']) === -1) {
