(function ($, require$$0, mailoptin_globals) {
	...
	var mailoptin_optin = {
	    ...
	    is_optin_visible: function (optin_config) {
	        ...
	        if (optin_config.global_success_cookie > 0 && js_cookie.get('mo_global_success_cookie')) return false;
	        // if global interaction/exit cookie found, do not display any optin.
	        if (optin_config.global_cookie > 0 && js_cookie.get('mo_global_cookie')) return false;
	        // if success cookie found for this optin, do not display it.
	        if (js_cookie.get('mo_success_' + $optin_uuid)) return false;
	        // if exit cookie found for this optin, do not dispay it.
	        if (js_cookie.get('mo_' + $optin_uuid)) return false;
	    ...
	    set_visitor_cookies: function () {
	        ...
	        if (mailoptin_globals__default['default'].is_new_returning_visitors_cookies === 'true') {
	            if (!js_cookie.get('mo_has_visited')) {
	                js_cookie.set('mo_is_new', 'true');
	                js_cookie.set('mo_has_visited', 'true', {expires: 3999});
	            }
	        }
	    },
	    ...
	    visitor_is_new: function () {
	        return js_cookie.get('mo_has_visited') === 'true' && js_cookie.get('mo_is_new') === 'true';
	    },

	    visitor_is_returning: function () {
	        return js_cookie.get('mo_has_visited') === 'true' && !js_cookie.get('mo_is_new');
	    },
	    ...
	    get_page_views: function () {
	        return Number(js_cookie.get('mo_page_views_counter'));
	    },
	    ...
	    set_cookie: function (type, optin_uuid, optin_js_config) {
	        ...
	        if (!test_mode) {
	            ...
	            js_cookie.set('mo_' + type + optin_uuid, true, {expires: cookie});
	            ...
	            js_cookie.set('mo_global_' + type + 'cookie', true, {expires: optin_js_config['global_' + type + 'cookie']});
	        }
	    },
	    ...
	    content_locker_init: function (optin_config) {
	        ...
	        if (mailoptin_optin.is_content_locker_enabled(optin_config)) {
	            ...
	            if ('obfuscation' == optin_config.content_lock_style) {
	                ...
	                $__default['default']('#' + optin_config.optin_uuid).nextAll().each(function (index, el) {
	    ...
	    initOptinForms: function () {
	        ...
	        $__default['default']('.mailoptin-click-trigger').click(function (event) {
