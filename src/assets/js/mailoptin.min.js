(function ($, mailoptin_globals) {
	...
	var mailoptin_optin = {
	    ...
	    optin_sound_selected: function (optin_config, optin_type) {
	        ...
	        if(optin_type === 'bar' || optin_type === 'lightbox' || optin_type === 'slidein') {
	            ...
	            if('none' !== optin_sound_config) {
	                var optin_sound_url = 'custom' !== optin_sound_config ? mailoptin_globals__default["default"].public_sound + optin_sound_config : optin_config.optin_custom_sound;
	    ...
	    eventSubscription: function () {
	        ...
	        $__default["default"](document.body).on('moOptin:show', function (e, optin_uuid, optin_js_config, optin_type) {
	    ...
	    content_locker_init: function (optin_config) {
	        ...
	        var nextAll2 = false,
	            ...
	            nextAll = $__default["default"]('#' + optin_config.optin_uuid).nextAll();

	        if (contentSelector.length > 0 && $__default["default"](contentSelector).length > 0) {
	            nextAll2 = $__default["default"](contentSelector);
	        }
